...
/******/ 	return __webpack_require__(__webpack_require__.s = "./diceybusiness.ts");
/******/ })
/************************************************************************/
/******/ ({
...
var dieButton = jquery_1.default('#make-die');
var rollButton = jquery_1.default('#roll-die');
var sumButton = jquery_1.default('#sum-die');
var diceCounter = 0;
var diceArray = [];
var Die = /** @class */ (function () {
    ...
    Die.prototype.roll = function () {
        ...
        var nextNumber = Math.floor(Math.random() * 7);
        var dieID = nextNumber;
        // diceClick.remove();
...
rollButton.click(function (event) {
    ...
    if (dieID == w) {
        ...
        jquery_1.default('body').append(nextNumber);
        console.log('It is me!' + dieID);
    }
    ;
});
dieButton.click(function (event) {
    ...
    console.log(w);
    var diceClick = jquery_1.default('<div class="square" id="dice">');
    var dieID = w;
    diceClick.append(dieID);
    dieHolder.append(diceClick);
    jquery_1.default('body').append(dieHolder);
    dieHolder.dblclick(function () {
        diceClick.remove();
    });
});
var diceClick = jquery_1.default('<div class="square" id="dice">');
var dieHolder = jquery_1.default('<div id="dieHolder">');
var w = Math.floor(Math.random() * 7);
var dieID = w;
